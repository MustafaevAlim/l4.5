...
## Оптимизации
Сбор профиля показывает такую ситуацию.(собирался минуту, основные действия это чтение из кафки и запись в бд)
```
(pprof) top20
...
Trace не показывает каких-либо сильных аномалий.